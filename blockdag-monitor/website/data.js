...
const NOTABLE_QUOTES = [
  ...
  { date: "June 12, 2026", isNew: true, tag: "misleading", text: "There are reports that this address was used in a Phishing scam. Please exercise caution when interacting with it. Reported by MetaMask. [Etherscan warning on the address tagged 'Blockdag Presale', 0x4C39Ed...78B2d367 — verifiable on chain]" },
  { date: "June 12, 2026", isNew: true, tag: "community", text: "You compress the eligible BDAG amount to 99.5%, then multiply the result (0.5%) by the proposed buyback value. The result corresponds to the amount shown in USDT. [community member valus, June 12 00:27 UTC — decoding the buyback 'compression']" },
  { date: "June 12, 2026", isNew: true, tag: "community", text: "68 million liquidity and 15 billion coins bought back, do the math. [community member Rajesh Ramsingh, June 12 01:08 UTC]" },
  { date: "June 12, 2026", isNew: true, tag: "community", text: "Direct swap was 0.01 then 0.02 then 0.03 and now 0.05. This project always shows you never take any deal, just wait till it keeps getting cheaper. [community member E C, June 12 06:59 UTC]" },
  { date: "June 12, 2026", isNew: true, tag: "community", text: "Shutting down staking forcing us to join their buyback program and sell without any assurance of receiving payment. [community member Joseph_V, June 12 06:09 UTC]" },
  { date: "June 12, 2026", isNew: true, tag: "misleading", text: "🚨 FINAL OPPORTUNITY: Allocations Shrinking. Sell BDAG at $0.05, buy at $0.00000044. Receive your approved USDT payment on October 1. Offer ends Monday 6PM UTC. [official channel, June 12 00:14 UTC]" },
  { date: "June 12, 2026", isNew: true, tag: "community", text: "I would sell my 30 million coins for 0.0002 immediately but i can not claim a single coin. [community member, responding on X, June 12]" }
];
