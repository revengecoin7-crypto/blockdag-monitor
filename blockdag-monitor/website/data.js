...
const NOTABLE_QUOTES = [
  ...
  { date: "June 6, 2026", isNew: true, tag: "misleading", text: "🚀 OVER 1 BILLION COINS ALREADY SOLD IN THE BUYBACK PROGRAM! The community is breaking records at lightning speed. Buy BDAG: $0.00000088. Lock in: 56X ROI. Buyback price: $0.01 per coin. Daily limits: uncapped. [official channel, June 6 16:42 UTC — '1 billion sold' counts new purchases, not payouts]" },
  { date: "June 7, 2026", isNew: true, tag: "community", text: "About the liquidity available in the wallets for payout, it is actually around $68M, screenshots attached from TronScan. Again, this does not guarantee anything since there is no smart contract and the control is centralized by the team and they have the keys. Why are they not paying now? [community member SilentAlfa, verified on TronScan]" },
  { date: "June 6, 2026", isNew: true, tag: "community", text: "BDAG admin offered us to sell our claim coins, then sends that to another community as a claim. In other words robbing Peter to pay Paul. [community member John Lombard, June 6 09:41 UTC]" },
  { date: "June 6, 2026", isNew: true, tag: "community", text: "I sold 20M coins on 2nd June at the rate of 0.005 for which a time limit of 42 hours had come but till today 6th June I have no confirmation of the same from the Blockdag side. [community member AK, June 6 08:01 UTC]" },
  { date: "June 6, 2026", isNew: true, tag: "community", text: "They are doing this just to increase the participants for their casino, they want old investors who bought at higher prices to sell their coins at cheap. [community member Hercules M, June 6 10:18 UTC]" },
  { date: "June 7, 2026", isNew: true, tag: "community", text: "You have to have a min of 10 million to sell back for .01 or .02 each. Is anyone holding 10mil or more released on their wallet? I would think only the ones that started this do. [community member Bert Weekley, June 7 02:06 UTC]" },
  { date: "June 6, 2026", isNew: true, tag: "community", text: "BTSE has completely suspended trading in bdag, and LBANK has already suspended deposits and withdrawals; it seems to be heading in the same direction. [community member Homer Sm, June 6 05:23 UTC]" },
  { date: "June 7, 2026", isNew: true, tag: "response", text: "The final phase is scheduled for June 30, 2026, which marks the Public Trading Launch for general presale buyers. This constitutes the final Token Generation Event (TGE). [official admin, June 7 13:47 UTC — another 'final' date]" },
  { date: "June 7, 2026", isNew: true, tag: "community", text: "So maths is we spend approximately $1000 and BDAG sold 1 billion token to us and give us all back 10 million. That's really courageous in current market. Looks like charitable trust. [community member Satish Trivedi, June 7 00:20 UTC]" }
];
