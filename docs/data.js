const PROMISES = [
  ...
  },
  {
    ...
    status: "broken",
    isNew: true,
    title: "\"Over 1 billion coins sold\" to the buyback — but the wallet holds a fraction of what it owes and nobody has been paid",
    ...
    reality: "On June 6 the official channel began marketing a milestone: 'OVER 1 BILLION COINS ALREADY SOLD IN THE BUYBACK PROGRAM.' But '1 billion sold' is a count of new Legacy Sale purchases at $0.00000088, not a record of payouts. No holder has documented receiving payment. AK (June 6 08:01): 'I sold 20M coins on 2nd June at the rate of 0.005 for which a 42 hours time limit had come but till today 6th June I have no confirmation.' The arithmetic does not close. Nada (June 6 02:56): 'If i sell the minimum 10m at price of 0.01 its 100 thousand dollars. The liquidity wallets have 70 thousand.' A single minimum-size seller at $0.01 is owed more than the buyback wallet reportedly holds. Community member John Lombard (June 6 09:41) named the structure: 'BDAG admin offered us to sell our claim coins, then sends that to another community as a claim. IN OTHER WORDS ROBBING PETER TO PAY PAUL.' Payout remains deferred to October/November and is widely expected to be settled in BDUSD, the project's own untested stablecoin, not USDT.",
    quotes: [
      ...
      { date: "June 6, 2026", text: "If i sell the minimum 10m at price of 0.01 its 100 thousand dollars. The liquidity wallets have 70 thousand. [community member Nada, 02:56 UTC]" },
...
const TIMELINE_EVENTS = [
  ...
  { date: "June 8, 2026", type: "broken", text: "Exchange exits accelerate alongside the buyback. Community reports BTSE has fully suspended BDAG trading and LBANK has suspended deposits and withdrawals (Homer Sm, June 6 05:23 UTC: 'BTSE has completely suspended trading in bdag, and LBANK has already suspended deposits and withdrawals'). Holders increasingly describe the buyback as a mechanism to drain old holders into the casino. Hercules M June 6 10:18 UTC: 'They are doing this just to increase the participants for their casino, they want old investors who bought at higher prices to sell their coins at cheap.' Three days into the '1 billion sold' milestone, still no documented payout." }
];
...
const NOTABLE_QUOTES = [
  ...
  { date: "June 6, 2026", isNew: true, tag: "community", text: "If i sell the minimum 10m at price of 0.01 its 100 thousand dollars. The liquidity wallets have 70 thousand. [community member Nada, June 6 02:56 UTC]" },
