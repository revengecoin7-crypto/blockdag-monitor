...
const NOTABLE_QUOTES = [
  ...
  { date: "June 9, 2026", isNew: true, tag: "community", text: "Can't claim my token allocation Batch 1, 2, 3, saying transaction likely to revert? [community member Jmilli, June 9 02:17 UTC]" },
  { date: "June 9, 2026", isNew: true, tag: "community", text: "Why can't I claim my coins, it keeps saying transaction failed? I was able to claim them the last 2 times on the 6th, but now it's not working this time. [community member Jordan Romero, June 9 03:33 UTC]" },
  { date: "June 9, 2026", isNew: true, tag: "community", text: "The problem persists in the claim for Batch 3. [Kova7, an account defending the project, posting the 'Transaction Failed' error screen on X, June 9]" },
  { date: "June 8, 2026", isNew: true, tag: "response", text: "Please follow the instructions on your dashboard. If it states that 10M BDAG is the minimum requirement, then transactions below that amount may not qualify. [official admin, June 8 06:54 UTC]" },
  { date: "June 9, 2026", isNew: true, tag: "community", text: "Deposits and withdrawals are now working normally at LBANK. [community member Homer Sm, June 9 05:34 UTC — confirming the earlier suspension was real and is now resolved]" },
  { date: "June 8, 2026", isNew: true, tag: "community", text: "Coin being on your dash and coin being in your wallet and sendible are not the same thing. You'll find the coins are very compressed. [community member Clark, June 8]" },
  { date: "June 9, 2026", isNew: true, tag: "community", text: "I sold 350 million tokens. I'm not getting $10.5 million, it is what it is. [community member Pdai Brother, June 9 04:52 UTC]" }
];
