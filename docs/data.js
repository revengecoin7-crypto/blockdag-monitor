...
const NOTABLE_QUOTES = [
  ...
  { date: "June 25, 2026", isNew: true, tag: "misleading", text: "🚀 BlockDAG Launching ChatGPT & Claude Competitor LLM Mode in 48H... a Large Language Model designed to compete with the biggest names in AI. Launch targeted within the next 48 hours. [official channel, June 25 02:26 UTC]" },
  { date: "June 25, 2026", isNew: true, tag: "response", text: "The recent announcement doesn't mean BlockDAG is suddenly trying to replace ChatGPT or Claude overnight... the community will be able to evaluate whether it provides real utility or is simply another ecosystem feature. [official admin walking back the LLM claim, June 25 08:11 UTC]" },
  { date: "June 25, 2026", isNew: true, tag: "community", text: "Are they running out of reasons to make people buy that they want to start to build LLM mode to compete with Claude and ChatGPT? They couldn't compete in the crypto world. [community member Himayoon N, June 25 08:09 UTC]" }
];
