...
const TIMELINE_EVENTS = [
  ...
  { date: "June 7, 2026", type: "broken", text: "The buyback's 'direct send' route is revealed to carry a 10-million-BDAG minimum per submission, locking out most holders whose tokens are unclaimed or compressed. Bert Weekley 02:06 UTC: 'You have to have a min of 10 million to sell back. Is anyone holding 10mil or more released? Only the ones that started this do.' What happens to sub-minimum BDAG sent to the buyback wallet is unanswered (xnick, June 6: 'Refunded or lost?'). Admin sets June 30, 2026 as the 'final TGE' and 'Public Trading Launch' (13:47 UTC) — yet another final date — while June purchases remain unclaimable: 'You will be able to claim your coins in the upcoming weeks' (13:49 UTC). 120 promises tracked, 113 broken (94.2%)." },
